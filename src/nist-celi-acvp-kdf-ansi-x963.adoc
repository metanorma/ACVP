...
:title-main: ACVP ANS X9.63 Key Derivation Function Algorithm JSON Specification
:title-main-short: ACVP ANS X9.63 Key Derivation Function Algorithm JSON Specification
:fullname: Christopher Celi
:affiliation: Information Technology Laboratory
:affiliation_subdiv: Computer Security Division
:doi: https://doi.org/10.6028/NIST.CSRC.AVCP.KDF-ANSI-X963
:series: nist-csts
