...
:title-main: ACVP Message Authentication Algorithm JSON Specification
:title-main-short: ACVP Message Authentication Algorithm JSON Specification
...
:address_2: 302 Sentinel Drive, Suite #300, Annapolis Junction, Maryland
:doi: https://doi.org/10.6028/NIST.CSRC.AVCP.MAC
:series: nist-csts
