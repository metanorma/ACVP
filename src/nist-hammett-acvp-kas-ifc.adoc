...
:title-main: ACVP KAS IFC JSON Specification
:title-main-short: ACVP KAS IFC JSON Specification
:fullname: Russell Hammett
:affiliation: HII
:address: 302 Sentinel Drive, Suite #300, Annapolis Junction, Maryland
:doi: https://doi.org/10.6028/NIST.CSRC.AVCP.KAS-IFC
:series: nist-csts
