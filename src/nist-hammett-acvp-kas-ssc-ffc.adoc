...
:title-main: ACVP KAS SSC FFC Specification
:title-main-short: ACVP KAS FFC ECC Specification
:fullname: Russell Hammett
:affiliation: HII
:address: 302 Sentinel Drive, Suite #300, Annapolis Junction, Maryland
:doi: https://doi.org/10.6028/NIST.CSRC.AVCP.KAS-SSC-FFC
:series: nist-csts
